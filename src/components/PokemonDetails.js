                ...
                <div className="card-body">
                  ...
                  <ul class="list-group">
                    <li class="list-group-item">
                      ...
                      <span class="float-right">{this.state.height} m</span>
                    </li>
                    <li class="list-group-item">
                      <strong>Weight</strong>
                      <span class="float-right">{this.state.weight} kg</span>
                    </li>
                    <li class="list-group-item">
                    ...
                    <li class="list-group-item">
                      ...
                      <span class="float-right">{this.state.catchRate}%</span>
                    </li>
                    <li class="list-group-item">
                      <strong>Egg Groups</strong>
                      <span class="float-right">{this.state.eggGroups}</span>
                    </li>
                    <li class="list-group-item">
                      <strong>Hatch Steps</strong>
                      <span class="float-right">{this.state.hatchSteps}</span>
                    </li>
                    <li class="list-group-item">
                      <strong>Gender Ratio</strong>
                      {this.state.genderRatioFemale < 0 ? (
                        <span class="float-right">Unknown</span>
                      ) : (
